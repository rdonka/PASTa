function [FFTplot] = plotstreamFFTmag(data,fileindex,maintitle,fsfieldname,streamfieldname,varargin)
% PLOTSTREAMFFTMAG  Creates frequency magnitude plots of the specified fiber
...
%
%   [FFTplot] = PLOTSTREAMFFTMAG(DATA, FILEINDEX, MAINTITLE, FSFIELDNAME, STREAMFIELDNAME)
%   computes and plots the FFT magnitude spectra for the specified data stream in
%   the given session.
%
% REQUIRED INPUTS:
...
%
% EXAMPLE USAGE:
%   % Plot FFT magnitude for session 1 with a frequency cutoff of 50 Hz
%   plotFFTmag(data, 1, 'Subject 427 - Session 1', 'fs', 'xmax', 50);
%
%   See also: plotFFTmag, plotstreamFFTpower, plotFFTpower
%
...
% For detailed instructions, see the PASTa user guide: https://rdonka.github.io/PASTaUserGuide/
    ...
    % Display
    disp(['PLOTSTREAMFFTMAG: Plotting FFT power spectrum for file: ',num2str(fileindex)])
...
%% Plot traces
    ...
    hold on;
    plot(F(1:currxlength), FFT(1:currxlength), 'Color', FFTcolor);
    set(gca, 'YScale', 'log')
