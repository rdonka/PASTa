...
% Import required and optional inputs into a structure
    ...
    for eachfile = 1:length(data)
        ...
        data(eachfile).(append('sessiontransients_blmean_',thresholdlabel)).inputs = inputs;
        data(eachfile).(append('sessiontransients_blmean_',thresholdlabel)).transientquantification = transientquantification(1:transientcount,:);
        ...
        if outputtransientdata == 1
            data(eachfile).(append('sessiontransients_blmean_',thresholdlabel)).transientstreamlocs = transientstreamlocs(1:transientcount,:);
            data(eachfile).(append('sessiontransients_blmean_',thresholdlabel)).transientstreamdata = transientstreamdata(1:transientcount,:);
        end
    end
end
